...
public final class PhoneUtils {
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) SaflyApplication.getInstance()
    ...
    public static void dial(final String phoneNumber) {
        SaflyApplication.getInstance().startActivity(getDialIntent(phoneNumber));
    }
    ...
    public static void call(final String phoneNumber) {
        SaflyApplication.getInstance().startActivity(getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        SaflyApplication.getInstance().startActivity(getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(SaflyApplication.getInstance(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = SaflyApplication.getInstance().getContentResolver();
