...
public class PopStyleIphonequehuo extends PushPopupWindow {
    public TextView tv_title;
    public TextView tv_text;
    public Button btn_sure;
    public Button btn_cancel;

    public PopStyleIphonequehuo(Context context) {
        super(context);
        initView();
...
//        setAnimationStyle();
    ...
    protected View generateCustomView() {
        View root = View.inflate(context, R.layout.pop_style_iphonequehuo, null);
