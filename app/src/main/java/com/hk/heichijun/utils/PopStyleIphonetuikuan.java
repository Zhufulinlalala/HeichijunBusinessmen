...
public class PopStyleIphonetuikuan extends PushPopupWindow {
    public TextView tv_title;
    public TextView tv_text;
    public Button btn_sure;
    public Button btn_cancel;

    public PopStyleIphonetuikuan(Context context) {
        super(context);
        initView();
...
//        setAnimationStyle();
    ...
    protected View generateCustomView() {
        View root = View.inflate(context, R.layout.pop_style_iphonetuikuan, null);
