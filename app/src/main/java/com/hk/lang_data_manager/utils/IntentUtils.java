...
public final class IntentUtils {
    ...
    public static Intent getInstallAppIntent(final File file, final String authority) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(SaflyApplication.getInstance(), authority, file);
        }
    ...
    public static Intent getLaunchAppIntent(final String packageName) {
        return SaflyApplication.getInstance().getPackageManager().getLaunchIntentForPackage(packageName);
    }
